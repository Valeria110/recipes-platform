...
export const BurgerMenu = () => {
  ...
  return (
    <>
      <header className='md:hidden sticky flex justify-between items-center top-0 left-0 w-dvw h-24 p-8 bg-orange-400 z-20'>
      ...
      <div
        className={`fixed top-24 w-dvw h-full flex flex-col gap-10 justify-center items-center md:hidden bg-orange-400 p-5 z-20 ${styles.menuContainer} ${isMenuOpen && styles.openMenu} `}
      >
